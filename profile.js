...
function getusers() {
    ...
    .then((response)=>{
        ...
        document.getElementById('Gmail-profile').innerHTML=user.email
        document.getElementById('name-profile').innerHTML=user.name
        document.getElementById('user-profile').innerHTML=user.username
        document.getElementById('post-conut').innerHTML=user.posts_count
        document.getElementById('comments_count').innerHTML=user.comments_count
        document.getElementById('Profile-picther').src=user.profile_image
        document.getElementById('posts-name').innerHTML=`${user.name } Posts`
